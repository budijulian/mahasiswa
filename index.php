<html>
<head>
    <title>DATA MAHASISWA - BUDIJULIAN</title>
...
<body>
<div style="border:0; padding:10px; margin-left:50px; width:760px; height:auto;">
<form action="action-input-data.php" method="POST" name="form-input-data">
    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr height="46">
                <td width="10%"> </td>
                <td width="25%"> </td>
                <td width="65%"><font color="orange" size="2">FORM TAMBAH DATA MAHASISWA</font></td>
        </tr>
        <tr height="46">
            <td> </td>
